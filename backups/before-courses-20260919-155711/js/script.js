...
// Present featured work before the detailed coursework record.
const coursesSection = document.getElementById("courses");
const projectsSection = document.getElementById("projects");
const experienceSection = document.getElementById("experience");
const organizationsSection = document.getElementById("organizations");
if (coursesSection && projectsSection && experienceSection && organizationsSection) {
  coursesSection.before(projectsSection, experienceSection, organizationsSection);
}
